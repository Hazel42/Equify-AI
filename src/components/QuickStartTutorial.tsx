  ...
  const steps = [
    {
      ...
      description:
        "Start by adding someone important to you - family, friends, or colleagues.",
      icon: Users,
    ...
    },
    {
      ...
      description:
        "Track when you help someone or when they help you to maintain balance.",
      icon: Gift,
    ...
    },
    {
      ...
      description:
        "Ask our AI assistant for personalized relationship advice and patterns.",
      icon: MessageCircle,
    ...
    },
    {
      ...
      description:
        "See visual insights about your relationship patterns and trends.",
      icon: TrendingUp,
      ...
      >
        ...
        <div className="p-6 bg-gradient-to-r from-green-500 to-blue-500 text-white">
          ...
          <p className="text-green-100 text-sm">
            Let's get you started with Equify!
          </p>
        ...
        <div className="p-6">
          <AnimatePresence mode="wait">
            ...
            >
              <div
                className={`p-4 rounded-xl border-2 ${steps[currentStep].color} mb-4`}
              >
