...
export const en = {
  ...
  addFavor: {
    title: 'Add New Favor',
    description: 'Record a favor you gave or received to track relationship balance.',
    whatHappened: 'What happened?',
    receivedFavor: 'I received a favor',
    gaveFavor: 'I gave a favor',
    person: 'Person',
    selectPerson: 'Select person',
    noRelationships: 'No relationships found. Add a relationship first.',
    category: 'Category',
    categories: {
      financial: 'Financial',
      financialDesc: 'Meals, gifts, loans',
      time: 'Time',
      timeDesc: 'Help, mentoring, listening',
      emotional: 'Emotional',
      emotionalDesc: 'Support, celebrations',
      professional: 'Professional',
      professionalDesc: 'Referrals, opportunities',
    },
    description: 'Description',
    descriptionPlaceholderReceived: 'e.g., Sarah bought me lunch at the new cafe downtown',
    descriptionPlaceholderGiven: 'e.g., Helped Mike move his furniture to his new apartment',
    estimatedValue: 'Estimated Value (optional)',
    valuePlaceholder: 'e.g., 25 or 2 hours',
    emotionalImpact: 'Emotional Impact',
    context: 'Context (optional)',
    contextPlaceholder: 'Any additional context about the situation...',
    saveFavor: 'Save Favor',
    analyzingWithAI: 'Analyzing with AI...',
    aiAnalyzing: 'AI is analyzing your relationship...',
    aiAnalyzingDesc: 'Generating personalized recommendations and insights based on your favor.',
  },
  recommendations: {
  ...
  auth: {
    ...
    signInSuccess: "You've been signed in successfully.",
